...
cloudinary.config({
  cloud_name: process.env.cloudinaryName || keys.cloudinaryName,
  api_key: process.env.cloudinaryApiKey || keys.cloudinaryApiKey,
  api_secret: process.env.cloudinaryApiSecret || keys.cloudinaryApiSecret
});
